...
public class DriveMap {
  ...
  public static final FeedForwardConstants kDriveFeedForwardConstants = new FeedForwardConstants(-0.13939, 0.029115, 0.0050108);
  ...
  public static final double kDriveMaxAngularSpeed = DriveMap.kRobotWheelBaseCircumference / kDriveMaxSpeedMetersPerSecond; // 180 degrees per second, half rotation

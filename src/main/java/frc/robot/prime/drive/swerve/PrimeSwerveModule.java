...
public class PrimeSwerveModule {
  ...
  public PrimeSwerveModule(
    ...
    m_steeringPIDController.setTolerance(2 / 360);
  ...
  public void setDesiredState(SwerveModuleState desiredState) {
    ...
    System.out.println(">>>");
    System.out.println("Desired angle in degrees: " + desiredState.angle.getDegrees());
    System.out.println("Current angle in degrees: " + encoderRotation.getDegrees());
    System.out.println("Difference in radians: " + m_steeringPIDController.getPositionError());
    System.out.println("PID Output: " + steeringOutput);
    System.out.println(">>>");
